...
namespace Yttrium
{
    ...
    namespace Core
    {
        ...
        public:
            ...
            //
            //__________________________________________________________________
            typedef typename ERROR::Type ErrorType; //!< alias
        ...
        template <typename ERROR>
        inline LegacyException<ERROR>:: LegacyException(const typename ERROR::Type err,
                                                        const char * const         formatString,
                                                        ...) noexcept :
        ...
        code(err)
        {
            ...
            ERROR::Format(info,sizeof(info),code);
        }
    }
