    ...
    namespace Memory
    {
        namespace Object
        {
            ...
            public:
                ...
                static const unsigned DEFAULT_PAGE_SHIFT = IntegerLog2<DEFAULT_PAGE_BYTES>::Value;
                static const size_t   LIMIT_OBJECT_BYTES = 512;
                static const unsigned LIMIT_OBJECT_SHIFT = IntegerLog2<LIMIT_OBJECT_BYTES>::Value;
