...
namespace Yttrium
{
    namespace Jive
    {
        ...
        const char * const ChemicalFormula:: Coef     = "ChemicalFormula::Coef";
        ...
        {
            const Rule * const coef = p.queryRule("COEFF");
            ...
            const Rule &OPT_COEF  = p.opt(Coef,COEF); // specific optional coeff
